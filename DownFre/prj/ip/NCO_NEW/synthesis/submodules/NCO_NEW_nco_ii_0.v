...
module NCO_NEW_nco_ii_0(clk, reset_n, clken, phi_inc_i, fsin_o, out_valid);
...
parameter rsfc = "NCO_NEW_nco_ii_0_sin_c.hex";
parameter rsff = "NCO_NEW_nco_ii_0_sin_f.hex";
parameter rcfc = "NCO_NEW_nco_ii_0_cos_c.hex";
parameter rcff = "NCO_NEW_nco_ii_0_cos_f.hex";
parameter nc = 1;
parameter log2nc =0;
